package com.dororo.future.gencopilot.exception;
...
public class GlobalExceptionHandler {
    ...
    /**
     * 使用 ExceptionUtil.getRootCause 获取异常链中最底层的异常,这通常是触发问题的原始异常。然后使用 ExceptionUtil.stacktraceToString 将整个异常堆栈转换为单个字符串,便于日志记录。
     */
